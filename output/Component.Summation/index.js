...
var eq1 = /* #__PURE__ */ Data_Eq.eq(Component_Counter.eqOutput);
...
var showAction = {
    show: /* #__PURE__ */ Data_Show_Generic.genericShow(genericAction_)(/* #__PURE__ */ Data_Show_Generic.genericShowConstructor(/* #__PURE__ */ Data_Show_Generic.genericShowArgsArgument(Component_Counter.showOutput))({
        reflectSymbol: function () {
            return "CounterOutput";
        }
    }))
...
var componentSpec = function (dictMonadAff) {
    var component1 = Component_Counter.component(dictMonadAff);
    ...
    var handleAction = function (v) {
        if (v.value0 instanceof Component_Counter.Equals10) {
            return pure(Data_Unit.unit);
        };
        if (v.value0 instanceof Component_Counter.FinishedPondering) {
            return pure(Data_Unit.unit);
        };
        if (v.value0 instanceof Component_Counter.CountChanged) {
            return bind(requestAll(Type_Proxy["Proxy"].value)(Component_Counter.GetCount.create))(function (counts) {
                return assign(_total1)(sum(counts));
            });
        };
        throw new Error("Failed pattern match at Component.Summation (line 66, column 31 - line 71, column 31): " + [ v.value0.constructor.name ]);
    };
    return {
