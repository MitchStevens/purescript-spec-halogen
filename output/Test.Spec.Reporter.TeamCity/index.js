...
var testFailed = function (d) {
    return function (e) {
        ...
        if (isEquals) {
            ...
            var read = function (s) {
                var $63 = Data_String_CodeUnits.take(1)(s) === "\"";
                if ($63) {
                    return readString(s);
                };
                return s;
...
var teamcityReporter = /* #__PURE__ */ Test_Spec_Reporter_Base.defaultReporter(Data_Map_Internal.empty)(function (v) {
    ...
    if (v instanceof Test_Spec_Runner_Event.TestEnd && v.value2 instanceof Test_Spec_Result.Failure) {
        ...
        return discard(tellLn(testFailed(attributes)(v.value2.value0)))(function () {
            return tellLn(testFinished(attributes));
        });
    };
    ...
    throw new Error("Failed pattern match at Test.Spec.Reporter.TeamCity (line 152, column 46 - line 177, column 48): " + [ v.constructor.name ]);
});
export {
    teamcityReporter,
    teamcity
