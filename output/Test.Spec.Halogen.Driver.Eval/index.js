...
var queueOrRun = function (ref) {
    return function (au) {
        return bind1(liftEffect(Effect_Ref.read(ref)))(function (v) {
            ...
            throw new Error("Failed pattern match at Test.Spec.Halogen.Driver.Eval (line 188, column 33 - line 190, column 57): " + [ v.constructor.name ]);
        });
    };
};
                ...
                return function (v1) {
                    if (v1 instanceof Halogen_Query_HalogenM.State) {
                        return bind1(liftEffect(Effect_Ref.read(ref)))(function (v2) {
                            ...
                            throw new Error("Failed pattern match at Test.Spec.Halogen.Driver.Eval (line 86, column 7 - line 92, column 21): " + [ v3.constructor.name ]);
                        });
                    };
                    ...
                    throw new Error("Failed pattern match at Test.Spec.Halogen.Driver.Eval (line 83, column 12 - line 139, column 33): " + [ v1.constructor.name ]);
                };
            };
...
var evalF = function (render) {
    return function (ref) {
        return function (v) {
            ...
            throw new Error("Failed pattern match at Test.Spec.Halogen.Driver.Eval (line 52, column 20 - line 58, column 62): " + [ v.constructor.name ]);
        };
    };
};
export {
