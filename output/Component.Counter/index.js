...
var genericOutput_ = {
    to: function (x) {
        ...
        throw new Error("Failed pattern match at Component.Counter (line 57, column 1 - line 57, column 33): " + [ x.constructor.name ]);
    },
    from: function (x) {
...
var genericAction_ = {
    to: function (x) {
        ...
        throw new Error("Failed pattern match at Component.Counter (line 46, column 1 - line 46, column 33): " + [ x.constructor.name ]);
    },
    from: function (x) {
...
var componentSpec = function (dictMonadAff) {
    ...
    var handleQuery = function ($117) {
        return outputOnCountChange((function (v) {
            ...
            throw new Error("Failed pattern match at Component.Counter (line 88, column 43 - line 104, column 25): " + [ v.constructor.name ]);
        })($117));
    };
    var $lazy_$$eval = $runtime_lazy("eval", "Component.Counter", function () {
        return Halogen_Component.mkEval({
            receive: Halogen_Component.defaultEval.receive,
            initialize: Halogen_Component.defaultEval.initialize,
            finalize: Halogen_Component.defaultEval.finalize,
            handleAction: $lazy_handleAction(72),
            handleQuery: handleQuery
        });
    });
    var $lazy_handleAction = $runtime_lazy("handleAction", "Component.Counter", function () {
        return function ($119) {
            return outputOnCountChange((function (v) {
                ...
                if (v instanceof Quadruple) {
                    return discard($lazy_$$eval(84)(new Halogen_Query_HalogenQ.Action(Double.value, Data_Unit.unit)))(function () {
                        return $lazy_$$eval(85)(new Halogen_Query_HalogenQ.Action(Double.value, Data_Unit.unit));
                    });
                };
                throw new Error("Failed pattern match at Component.Counter (line 77, column 44 - line 85, column 37): " + [ v.constructor.name ]);
            })($119));
        };
    });
    var $$eval = $lazy_$$eval(70);
