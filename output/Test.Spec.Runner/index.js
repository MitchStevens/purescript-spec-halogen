                    ...
                    return bind(lift($$try(Effect_Aff_AVar.take($$var))))(function (res) {
                        ...
                        if (res instanceof Data_Either.Right) {
                            return discard2($$yield(res.value0))(function () {
                                return $lazy_loop(171);
                            });
                        };
                        throw new Error("Failed pattern match at Test.Spec.Runner (line 167, column 7 - line 171, column 15): " + [ res.constructor.name ]);
                    });
                });
                var loop = $lazy_loop(165);
                return loop;
            });
        });
    };
...
var _run = function (dictFunctor) {
    ...
    return function (config) {
        ...
        var runItem = function (keepRunningVar) {
            return function (v) {
                return bind(liftEffect1(Effect_Ref.read(keepRunningVar)))(function (keepRunning) {
                    ...
                    throw new Error("Failed pattern match at Test.Spec.Runner (line 115, column 7 - line 142, column 40): " + [ v.test.constructor.name ]);
                });
            };
        };
        var loop = function (keepRunningVar) {
            return function (tests) {
                ...
                return map(Data_Array.concat)($$for(groups)(function (g) {
                    var $100 = (Data_Array_NonEmpty.head(g)).isParallelizable;
                    if ($100) {
        ...
        return function ($107) {
            return $106(collect($107));
        };
    };
};
var evalSpecT = function (dictFunctor) {
        ...
        return function (reporters) {
            return function (spec) {
                return mapFlipped1(_run1(config)(spec))(function (runner) {
                    ...
                    if (config.exit) {
                        return discard1(liftEffect(Test_Spec_Console.write(Test_Spec_Style.styled(Test_Spec_Style.yellow)(fold([ "WARNING: The use of `runSpec` or `runSpecT` under NodeJS is deprecated ", "and will be removed in the next major release. ", "Please migrate to `runSpecAndExitProcess` from the 'spec-node' package." ])))))(function () {
                            return bind1($$try(reportedEvents))(function (v) {
                                ...
                                if (v instanceof Data_Either.Right) {
                                    return liftEffect((function () {
                                        var code = (function () {
                                            var $104 = Test_Spec_Summary.successful(v.value0);
                                            if ($104) {
                                                return 0;
                                            };
                                            return 1;
                                ...
                                throw new Error("Failed pattern match at Test.Spec.Runner (line 199, column 30 - line 207, column 23): " + [ v.constructor.name ]);
                            });
                        });
                    };
...
var evalSpecT1 = /* #__PURE__ */ evalSpecT(Data_Identity.functorIdentity);
var runSpecPure$prime = function (config) {
    return function (reporters) {
        return function (spec) {
            return $$void(un(Data_Identity.Identity)(evalSpecT1(config)(reporters)(spec)));
        };
    };
};
var run = function () {
    return runSpecPure$prime(Test_Spec_Config.defaultConfig);
};
var runSpec$prime = function () {
    return runSpecPure$prime;
};
var runSpecPure = function (reporters) {
    return function (spec) {
        return runSpecPure$prime(Test_Spec_Config.defaultConfig)(reporters)(spec);
    };
};
...
var runSpecT = function (dictFunctor) {
    var evalSpecT2 = evalSpecT(dictFunctor);
    return function () {
        return evalSpecT2;
    };
};
