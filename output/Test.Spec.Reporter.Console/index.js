...
var printSummary = function (dictMonadWriter) {
    ...
    return function ($123) {
        ...
        })(Test_Spec_Summary.summarize($123));
    };
};
            ...
            return function (a) {
                return bind1(get1)(function (s) {
                    return discard1((function () {
                        if (s.lastPrintedSuitePath instanceof Data_Maybe.Just && eq(s.lastPrintedSuitePath.value0)(path)) {
                            return pure1(Data_Unit.unit);
                        };
                        return discard1(tellLn(Test_Spec_Style.styled(append1(Test_Spec_Style.bold)(Test_Spec_Style.magenta))(intercalate(" \xbb ")(Test_Spec_Tree.parentSuiteName(path)))))(function () {
                            return put((function () {
                                var $95 = {};
                                for (var $96 in s) {
                                ...
                                $95.lastPrintedSuitePath = new Data_Maybe.Just(path);
                                return $95;
                            })());
                        });
                    })())(function () {
